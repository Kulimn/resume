      ...
      <div class="container">
          <div class="row">
              ...
              <div class="col-12 col-sm-12  col-md-6  col-lg-6  col-xl-6  col-xxl-6">
                ...
                <a href="https://drive.google.com/file/d/1THQh3B1AygDQdbtojklT5bk2rNBsY1PS/view?usp=sharing" class="ds-download-button">Download Resume <i class="ri-download-line"></i></a>
              </div>
          </div>
      </div>
    </section>
    ...
    <section class="ds-projects-section">
      <div class="container">
          ...
          <div class="row ds-projects-listing-section">
            ...
            <div class="col-12 col-sm-12  col-md-4  col-lg-4  col-xl-4  col-xxl-4 ds-projects-loop">
                <figure>
                  <a href="https://drive.google.com/file/d/1qWVOhaOUcezKeUcokyzht-RtT9yvo3Il/view?usp=drive_link" target="_blanck" class="ds-link-button"><i class="ri-external-link-line"></i></a>
